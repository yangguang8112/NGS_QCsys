...
def get_clf_algos():
	...
	# algorithms['RFC_3class'] = RandomForestClassifier(random_state=1, class_weight={2:1, 1:38, 0:49})
	algorithms['RFC_3class'] = RandomForestClassifier(random_state=1, class_weight='balanced')
